...
class GroupClassMeetingRecordAdmin(admin.ModelAdmin):
    readonly_fields = (
        'scheduled_class',
        'group_class',
        'teacher_name',
...
class GroupClassStudentAttendanceRecordAdmin(admin.ModelAdmin):
    readonly_fields = (
...
admin.site.register(GroupClassMeetingRecord, GroupClassMeetingRecordAdmin)
admin.site.register(
    GroupClassStudentAttendanceRecord,
    GroupClassStudentAttendanceRecordAdmin
)
