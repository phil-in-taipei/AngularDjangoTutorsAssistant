...
class StaffRecurringScheduledClassForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if instance and instance.pk and instance.recurring_start_time and instance.recurring_finish_time:
            matched_duration = get_duration_from_times(
                instance.recurring_start_time, instance.recurring_finish_time
            )
            if matched_duration:
